 ...
 */
public class updateTaksGrafFragment extends Fragment {
    EditText editText1, editText2, editText3;
    Button updateBtn;
    public updateTaksGrafFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_update_taksgraf, container, false);
        ...
        updateBtn = view.findViewById(R.id.TaksGrafUpdateButton);
            ...
            public void onClick(View v) {
                if ( editText1.getText().toString().isEmpty()
                    ...
                    try {
                        ...
                        MainActivity.myAppDatabase.mydaotemp().updateTaksidiotikoGrafeio(taksGraf);
