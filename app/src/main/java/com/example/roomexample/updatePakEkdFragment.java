 ...
 */
public class updatePakEkdFragment extends Fragment {
    EditText editText1, editText2, editText3, editText4, editText5;
    Button updateBtn;
    public updatePakEkdFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_update_pakekd, container, false);
        ...
        updateBtn = view.findViewById(R.id.PakEkdUpdateButton);
            ...
            public void onClick(View v) {
                if ( editText1.getText().toString().isEmpty()
                    ...
                    try {
                        ...
                        MainActivity.myAppDatabase.mydaotemp().updatePaketoEkdromhs(pakEkd);
